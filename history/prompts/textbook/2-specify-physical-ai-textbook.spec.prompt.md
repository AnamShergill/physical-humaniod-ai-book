...
user: Bruno
command: /sp.specify
labels: [specification, textbook, physical-ai, robotics, ros2, nvidia-isaac]
links:
  ...
  pr: null
files:
 - specs/1-textbook/spec.md
 - specs/1-textbook/checklists/requirements.md
tests:
---

## Prompt

Specify the textbook chapters and lessons for Physical AI & Humanoid Robotics:
1. Introduction to Physical AI & Embodied Intelligence
2. ROS 2 Fundamentals (Nodes, Topics, Services, Python integration)
3. Robot Simulation with Gazebo & Unity (Physics, Sensors, Digital Twin)
4. NVIDIA Isaac Platform (Perception, VSLAM, Navigation, Sim-to-Real)
5. Vision-Language-Action (Voice-to-Action, LLM planning, Cognitive Robotics)
6. Capstone: Autonomous Humanoid Robot Project
Include weekly breakdown, hardware requirements, edge kit setup, and lab options.
...
- ✅ Impact: Created comprehensive specification for Physical AI & Humanoid Robotics textbook
- 🧪 Tests: N/A (specification phase)
- 📁 Files: Created spec at specs/1-textbook/spec.md and checklist at specs/1-textbook/checklists/requirements.md
- 🔁 Next prompts: Ready for planning phase with /sp.plan
- 🧠 Reflection: Specification covers all requested textbook components with clear requirements
